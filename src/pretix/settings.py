...
#EMAIL_BACKEND = EMAIL_CUSTOM_SMTP_BACKEND = 'django.core.mail.backends.filebased.EmailBackend'
EMAIL_FILE_PATH = "/data/emails"  #This is temporary for production until email server is configured
EMAIL_TIMEOUT = 60
